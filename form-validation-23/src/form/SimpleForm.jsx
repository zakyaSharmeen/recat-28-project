...
function SimpleForm() {
  ...
  // State to hold submitted values for display
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      setSubmittedValues(formValues); // Save the submitted values for display

      // Reset form values to empty strings after submission
      setFormValues({
        username: '',
        email: '',
        password: '',
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}> {/* Handle form submission */}
        <div className="form-group">
          ...
          />
          {/* Show error message only when the field has been touched, there's an error, and the form has not been submitted */}
          {!isSubmit && touched.username && formErrors.username && (
        ...
        <div className="form-group">
          ...
          />
          {/* Show error message only when the field has been touched, there's an error, and the form has not been submitted */}
          {!isSubmit && touched.email && formErrors.email && (
        ...
        <div className="form-group">
          ...
          />
          {/* Show error message only when the field has been touched, there's an error, and the form has not been submitted */}
          {!isSubmit && touched.password && formErrors.password && (
      ...
      {/* Display submitted values if form was submitted */}
      {isSubmit && submittedValues && (
        <div className="submitted-values">
          ...
          <p><strong>Password:</strong> {submittedValues.password}</p>
        </div>
      )}
    </div>
  );
